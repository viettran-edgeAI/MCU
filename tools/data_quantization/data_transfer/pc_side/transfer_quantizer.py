...
Usage: python3 transfer_quantizer.py --model_name <model_name> --port <serial_port>

Example: python3 transfer_quantizer.py --model_name digit_model --port /dev/ttyACM0
         python3 transfer_quantizer.py -m digit_model -p /dev/ttyACM0
"""
