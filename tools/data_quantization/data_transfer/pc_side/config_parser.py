...
def find_rf_board_config():
    """
    Locate Rf_board_config.h in the library structure.
    ...
    config_path = lib_root / "src" / "Rf_board_config.h"
    ...
    possible_paths = [
        lib_root / "Rf_board_config.h",
        lib_root / "include" / "Rf_board_config.h",
    ]
