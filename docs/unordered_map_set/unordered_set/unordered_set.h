...
#include <stdexcept>
#include "../unordered_map_s/unordered_map_s.h"
#include "../unordered_set_s/unordered_set_s.h"
#include <type_traits>
#include <cassert>
#include <utility>   
...
public:
    ...
    void remap(uint16_t newChainCap) noexcept {
        ...
        chain = new unordered_set_s_s*[newChainCap];
        memset(chain, 0, newChainCap * sizeof(unordered_set_s_s*)); // Initialize all pointers to nullptr
...
public:
        ...
        rangeMap(o.rangeMap)
    {
        ...
        chain = new unordered_set_s_s*[this->cap_];
...
public:
    ...
    size_t fit() {
        ...
        if (activeSets < cap_ / 3 && cap_ > INIT_CAP) {
            ...
            unordered_set_s_s** newChain = new unordered_set_s_s*[newCap];
