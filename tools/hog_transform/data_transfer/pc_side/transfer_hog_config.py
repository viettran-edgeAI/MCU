...
def main():
    if len(sys.argv) != 3:
        print("Usage: python3 transfer_hog_config.py <model_name> <serial_port>")
        print("Example: python3 transfer_hog_config.py dataset_features /dev/ttyUSB0")
        print("\nNote: This will transfer <model_name>_hogcfg.json to /<model_name>/ on ESP32")
        return 1
