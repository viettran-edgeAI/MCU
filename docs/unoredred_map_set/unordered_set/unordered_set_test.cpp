...
void print_set(const unordered_set<int>& mySet) {
    std::cout << "mySet: ";
...
bool fake_pass_detecter(unordered_set<int>& mySet, std::unordered_set<int>& stdSet) {
...
void random_test(unordered_set<int>& mySet, std::unordered_set<int>& stdSet, int num_iterators = 10000) {   
...
void sequential_test(unordered_set<int>& mySet, std::unordered_set<int>& stdSet, int num_iterators = 1000) {
...
void find_test(unordered_set<int>& mySet, std::unordered_set<int>& stdSet, int num_iterators = 10000) {
...
void benchmark_test(unordered_set<int>& mySet, std::unordered_set<int>& stdSet, int total_iterators = 10000) {
...
void constructor_test(unordered_set<int>& mySet, std::unordered_set<int>& stdSet) {
    std::cout << "------------- Constructor test -------------" << std::endl;
    int total_err = 0;
    unordered_set<int> mySet1 = mySet;
    // copy constructor
...
void memory_usage_comparison(unordered_set<int>& mySet, std::unordered_set<int>& /*unused*/) {
