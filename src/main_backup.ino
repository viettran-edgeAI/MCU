...
class RandomForest{
    ...
    Rf_base base;           // inference
    Rf_config config;       // inference
    Rf_categorizer categorizer;     // inference

    Rf_tree_container forest_container;     // inference
    unordered_map<uint8_t, uint8_t> predictClass;   // inference
    Rf_pending_data pending_data; // pending data waiting for true labels from feedback action 

    bool clean_yet = false; 

public:
    Rf_logger logger;       // inference
    ...
    Rf_node_predictor node_predictor; 

    b_vector<ID_vector<uint16_t,2>, SMALL> dataList; 
