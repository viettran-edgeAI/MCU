...
//        - cap_ : total number of maps in the chain (available + reserve type 1, 2) - size of dynamic array (chain)
    ...
    private:
        ...
        void remap(uint16_t newChainCap) noexcept {
            ...
            chain = new unordered_map_s_s*[newChainCap];
            memset(chain, 0, newChainCap * sizeof(unordered_map_s_s*)); // Initialize all pointers to nullptr
    ...
    public:
            ...
            chain_size(o.chain_size)
        {
            ...
            chain = new unordered_map_s_s*[this->cap_];
        ...
        */
        ...
        size_t fit() {
            ...
            if (activeMaps < cap_ / 3 && cap_ > INIT_CAP) {
                ...
                auto* newChain = new unordered_map_s_s*[newCap];
