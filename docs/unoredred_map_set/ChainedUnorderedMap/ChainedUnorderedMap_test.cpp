...
void printMap(ChainedUnorderedMap<uint16_t, uint16_t>& myMap) {
...
bool fake_pass_detecter(ChainedUnorderedMap<uint16_t, uint16_t>& myMap, std::unordered_map<uint16_t, uint16_t>& stdMap) {
...
void iterator_test(ChainedUnorderedMap<uint16_t, uint16_t>& myMap, std::unordered_map<uint16_t, uint16_t>& stdMap, int num_iterators = 10) {  
...
void random_test(ChainedUnorderedMap<uint16_t, uint16_t>& myMap, std::unordered_map<uint16_t, uint16_t>& stdMap, int num_iterrators = 4) {
...
void sequential_test(ChainedUnorderedMap<uint16_t, uint16_t>& myMap, std::unordered_map<uint16_t, uint16_t>& stdMap, int num_iterators = 10) {
...
void find_test(ChainedUnorderedMap<uint16_t, uint16_t>& myMap, std::unordered_map<uint16_t, uint16_t>& stdMap, int num_iterators = 10) {
...
// test for at() method
void at_test(ChainedUnorderedMap<uint16_t, uint16_t>& myMap, std::unordered_map<uint16_t,uint16_t>& stdMap, int num_iterators = 10) {
...
void first_benchmark(ChainedUnorderedMap<uint16_t, uint16_t>& myMap,std::unordered_map<uint16_t, uint16_t>& stdMap, int num_iterrators = 10) {
...
void memory_usage_comparison(ChainedUnorderedMap<uint16_t, uint16_t>& myMap,std::unordered_map<uint16_t, uint16_t>& /*unused*/) {
...
void searching_benchmark_hits(ChainedUnorderedMap<uint16_t, uint16_t>& myMap, std::unordered_map<uint16_t, uint16_t>& stdMap, int num_iterators = 40) {
    myMap.clear();
    stdMap.clear();
...
void searching_benchmark_misses(ChainedUnorderedMap<uint16_t, uint16_t>& myMap, std::unordered_map<uint16_t, uint16_t>& stdMap, int num_iterators = 40) {
    ...
    for(int iter = 0; iter < num_iterators; iter++) {
        ...
        // Test ChainedUnorderedMap misses
        start = std::chrono::high_resolution_clock::now();
        for(uint16_t i = 0; i < miss_count; i++) {
...
void searching_benchmark_split(ChainedUnorderedMap<uint16_t, uint16_t>& myMap, std::unordered_map<uint16_t, uint16_t>& stdMap, int num_iterators = 40) {
...
void searching_benchmark2(ChainedUnorderedMap<uint16_t, uint16_t>& myMap, std::unordered_map<uint16_t, uint16_t>& stdMap, int num_iterators = 40) {
...
void fullness_test(std::vector<float> fullness_levels = {0.7f, 0.8f, 0.9f, 1.0f}, int num_iterators = 40) {
    ...
    for (float level : fullness_levels) {
        ...
        ChainedUnorderedMap<uint16_t, uint16_t> myMap;
...
void constructors_test(ChainedUnorderedMap<uint16_t, uint16_t>& myMap, std::unordered_map<uint16_t, uint16_t>& stdMap) {
    std::cout << "------------- Constructors test -------------" << std::endl;
    int total_err = 0;
    ChainedUnorderedMap<uint16_t, uint16_t> myMap1 = myMap;  // backup myMap
    // copy constructor
    ChainedUnorderedMap<uint16_t, uint16_t> myMap2(myMap);
    ...
    // move constructor
    ChainedUnorderedMap<uint16_t, uint16_t> myMap3(std::move(myMap));
    ...
    // copy assignment
    ChainedUnorderedMap<uint16_t, uint16_t> myMap4;
    myMap4 = myMap;
    ...
    // move assignment
    ChainedUnorderedMap<uint16_t, uint16_t> myMap5;
...
int main(){
    ...
    // ChainedUnorderedMap<int, std::string> myMap2;
    // for(int i= 0; i < 10000; i++){
