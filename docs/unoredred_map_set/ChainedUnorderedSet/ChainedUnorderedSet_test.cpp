...
template<typename T>
void print_map(ChainedUnorderedSet<T>& mySet){
...
template<typename T>
bool fake_pass_detecter(ChainedUnorderedSet<T>& mySet, std::unordered_set<T>& stdSet) {
...
void iterator_test(ChainedUnorderedSet<int>& mySet, std::unordered_set<int>& stdSet, int num_iterators = 10) {  
...
void random_test(ChainedUnorderedSet<int>& mySet, std::unordered_set<int>& stdSet, int num_iterrators = 40) {
...
void sequential_test(ChainedUnorderedSet<int>& mySet, std::unordered_set<int>& stdSet, int num_iterators = 10) {
...
void constructors_test(ChainedUnorderedSet<int>& mySet, std::unordered_set<int>& stdSet) {
    std::cout << "------------- Constructors test -------------" << std::endl;
    int total_err = 0;
    ChainedUnorderedSet<int> mySet1 = mySet;  // backup mySet
    // copy constructor
    ChainedUnorderedSet<int> mySet2(mySet);
    ...
    // move constructor
    ChainedUnorderedSet<int> mySet3(std::move(mySet));
    ...
    // copy assignment
    ChainedUnorderedSet<int> mySet4;
    mySet4 = mySet;
    ...
    // move assignment
    ChainedUnorderedSet<int> mySet5;
...
void fullness_test(std::vector<float> fullness_levels = {0.7f, 0.8f, 0.9f, 1.0f}, int num_iterators = 40) {
    ...
    for (float level : fullness_levels) {
        ...
        ChainedUnorderedSet<uint16_t> mySet;
