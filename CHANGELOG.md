...
- added decision tree mode : when num_trees = 1 , switch to decision tree mode 
    ...
    - add enable_decision_tree_mode() API
- added boostrap_bits : use less memory  for boostrap sampling.
- add a demonstration of similar training results between the PC and MCU versions.
...
## [2025-11-17] — Feature additions & API surface improvements (grouped)
...
## [2025-11-14] — Maintenance and tooling (grouped)
...
## [2025-11-12] — HOG transform completion & workspace sync
...
## [2025-11-10] — Transfer improvements & minor fixes
...
## [2025-11-07] — BIG UPGRADE: dynamic layout & model improvements
...
## [2025-11-06] — BIG UPGRADE: partial loading mode (very large dataset support)
...
## [2025-10-27] — Performance & container upgrades
...
## [2025-10-05] — Filesystem change: SPIFFS -> LittleFS
...
## [2025-10-07] — Inference speedup and algorithm adjustments
...
## [2025-09-03] — Memory & diagnostics improvements
...
## [2025-08-30] — BIG UPGRADE: Rf_data container change (memory reduction)
...
## [2025-08-15] — BIG UPGRADE: tree conversion, initializer upgrades, categorizer addition
...
## [2025-07 -> 2025-08] — Tooling, transfer utilities, pre_train & processing pipelines
...
## [2025-06-23] — Core container and baseline features (initial release)
