...
void print_map(const unordered_map_s<uint8_t, uint8_t>& m){
    std::cout << "------------- Print map -------------\n";
    for (auto& kv : m) {
...
bool fake_pass_detecter(unordered_map_s<uint8_t, uint8_t>& myMap, std::unordered_map<uint8_t, uint8_t>& stdMap) {
...
void constructors_test(unordered_map_s<uint8_t, uint8_t>& myMap, std::unordered_map<uint8_t, uint8_t>& stdMap) {
    std::cout << "------------- Constructors test -------------" << std::endl;
    unordered_map_s<uint8_t, uint8_t> myMap1 = myMap;  // backup myMap
    // copy constructor
    unordered_map_s<uint8_t, uint8_t> myMap2(myMap);
    fake_pass_detecter(myMap2,stdMap);

    // move constructor
    unordered_map_s<uint8_t, uint8_t> myMap3(std::move(myMap));
    fake_pass_detecter(myMap3,stdMap);
    myMap = myMap1; // restore myMap

    // copy assignment
    unordered_map_s<uint8_t, uint8_t> myMap4;
    myMap4 = myMap;
    fake_pass_detecter(myMap4,stdMap);

    // move assignment
    unordered_map_s<uint8_t, uint8_t> myMap5;
...
void random_test(unordered_map_s<uint8_t, uint8_t>& myMap, std::unordered_map<uint8_t, uint8_t>& stdMap, int num_iterators = 10000) {
...
void random_test_2(unordered_map_s<int, int> & myMap, std::unordered_map<int, int>& stdMap, int num_iterators = 10000) {
...
void sequentially_test(unordered_map_s<uint8_t, uint8_t>& myMap, std::unordered_map<uint8_t, uint8_t>& stdMap, int num_iterators = 10000) {    
...
void fullness_test(std::vector<float> fullness_levels = {0.7f, 0.8f, 0.9f, 1.0f}, int num_iterators = 10000) {
    ...
    for (float level : fullness_levels) {
        ...
        unordered_map_s<uint8_t, uint8_t> myMap;
...
void operator_test(unordered_map_s<uint8_t, uint8_t>& myMap, std::unordered_map<uint8_t, uint8_t>& stdMap, int num_iterators = 10000) {
...
void find_test(unordered_map_s<uint8_t, uint8_t>& myMap, std::unordered_map<uint8_t, uint8_t>& stdMap, int num_iterators = 10000) {
...
void operation_benchmark(unordered_map_s<uint8_t, uint8_t>& myMap, std::unordered_map<uint8_t, uint8_t>& stdMap, int total_iterators = 10000) {
...
void searching_benchmark(unordered_map_s<uint8_t, uint8_t>& myMap, std::unordered_map<uint8_t, uint8_t>& stdMap, int num_iterators = 10000) {
...
void iterator_benchmark(unordered_map_s<uint8_t, uint8_t>& myMap, std::unordered_map<uint8_t, uint8_t>& stdMap, int num_iterators = 10000) {
...
void memory_usage_comparison(unordered_map_s<uint8_t, uint8_t>& myMap,std::unordered_map<uint8_t, uint8_t>& /*unused*/) {
...
// getValue() test
void getValue_test(unordered_map_s<uint8_t, uint8_t>& myMap, std::unordered_map<uint8_t, uint8_t>& stdMap) {
...
int main(){
    ...
    unordered_map_s<int, int> myMap2;
    ...
    unordered_map_s<const char*, int> myMap3;
